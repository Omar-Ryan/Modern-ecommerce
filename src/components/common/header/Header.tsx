          ...
          <div className="relative flex items-center justify-between h-16">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              >
                ...
                <div
                  className={` absolute bottom-0 right-0 flex items-center justify-center w-6 h-6 text-white bg-red-700 rounded-full translate-x-1/4 translate-y-1/4 ${
                    pumpAnimate ? "pumpCartQuantity" : ""
                  }`}
                >
                  {cartQuantity}
                </div>
